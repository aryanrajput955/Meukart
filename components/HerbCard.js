  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
      ...
      <div className="relative h-56 md:h-64 bg-light-green overflow-hidden group">
        ...
        />
        {/* Category Badge */}
        <div className="absolute top-4 right-4 bg-primary-green text-white text-xs font-medium px-4 py-2 rounded-full shadow-lg">
          {herb.category}
        </div>
      </div>
      ...
      <div className="p-6 md:p-8 flex-1 flex flex-col">
        <h3 className="text-xl md:text-2xl font-semibold text-primary-green-dark mb-3">
          {herb.name}
        </h3>
        <p className="text-gray text-sm md:text-base mb-4 line-clamp-2 leading-relaxed">
          {herb.description}
        </p>
        ...
        {/* Learn More Link */}
        <button className="text-primary-green text-sm md:text-base font-semibold hover:text-secondary-green transition-colors flex items-center gap-2 mt-auto">
